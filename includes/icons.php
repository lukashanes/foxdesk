...
/**
 * Icon System
 * Returns SVG icons to replace FontAwesome dependencies.
 * Uses Lucide/Feather style clean SVGs.
 */
...
function get_icon_path($name)
{
    ...
    $icons = [
        ...
        'ticket-alt' => '<path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline>',
        'ticket' => '<rect x="2" y="6" width="20" height="12" rx="2"></rect><circle cx="12" cy="12" r="2"></circle><path d="M6 12h.01M18 12h.01"></path>', // Simplified ticket
        ...
        'arrow-up-down' => '<path d="m7 15 5 5 5-5"></path><path d="m7 9 5-5 5 5"></path>',
        ...
        'user-friends' => '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path>', // Same as users
        'user' => '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle>',
        'user-circle' => '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle>', // Simplified to regular user for cleaner look
        'user-secret' => '<path d="M20 12v6a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-6"></path><path d="M2 12h20"></path><path d="M12 2a5 5 0 0 0-5 5v5h10V7a5 5 0 0 0-5-5z"></path>', // Hat/Spy look
        'user-minus' => '<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="23" y1="11" x2="17" y2="11"></line>',
        'building' => '<rect x="4" y="2" width="16" height="20" rx="2" ry="2"></rect><path d="M9 22v-4h6v4"></path><line x1="8" y1="6" x2="10" y2="6"></line><line x1="14" y1="6" x2="16" y2="6"></line><line x1="8" y1="10" x2="10" y2="10"></line><line x1="14" y1="10" x2="16" y2="10"></line><line x1="8" y1="14" x2="10" y2="14"></line><line x1="14" y1="14" x2="16" y2="14"></line>',
        ...
        'cloud-upload-alt' => '<path d="M21.2 15c.7-1.2 1.2-2.5 1.2-3.9 0-4.4-3.6-8-8-8-3.2 0-6 1.9-7.2 4.8C3.2 8.4.9 11.2.9 14.6c0 4.1 3.3 7.4 7.4 7.4h11.4c3.6 0 6.5-2.9 6.5-6.5-.1-1.8-.8-3.4-1.9-4.5z"></path><polyline points="17 9 12 4 7 9"></polyline><line x1="12" y1="4" x2="12" y2="15"></line>',
        ...
        'tasks' => '<path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>', // Actually clipboard-list is better, but this is 'edit' style, let's use list-checks
        'exclamation-circle' => '<circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line>',
        ...
        'save' => '<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v13a2 2 0 0 1-2 2z"></path><polyline points="17 21 17 13 7 13 7 21"></polyline><polyline points="7 3 7 8 15 8"></polyline>',
        ...
        'sign-out-alt' => '<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line>',
        ...
        'dot-circle' => '<circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="3"></circle>',
        'thermometer' => '<path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"></path>',
        'thermometer-empty' => '<path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"></path>',
        'thermometer-quarter' => '<path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"></path>',
        'thermometer-half' => '<path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"></path>',
        'thermometer-three-quarters' => '<path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"></path>',
        'thermometer-full' => '<path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"></path>',
        'comment' => '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>',
        'exchange-alt' => '<polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line>',
        ...
        'bug' => '<rect x="8" y="6" width="8" height="14" rx="4"></rect><line x1="4" y1="10" x2="8" y2="10"></line><line x1="4" y1="14" x2="8" y2="14"></line><line x1="16" y1="10" x2="20" y2="10"></line><line x1="16" y1="14" x2="20" y2="14"></line><line x1="4" y1="18" x2="8" y2="18"></line><line x1="16" y1="18" x2="20" y2="18"></line>',
        ...
        'question-circle' => '<circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line>',
        ...
        'lightbulb' => '<line x1="9" y1="18" x2="15" y2="18"></line><line x1="10" y1="22" x2="14" y2="22"></line><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 16.5 8 4.5 4.5 0 0 0 12 3.5 4.5 4.5 0 0 0 7.5 8c0 1.43.5 2.51 1.5 3.5.76.76 1.23 1.52 1.41 2.5h4.68z"></path>',
        'calendar-alt' => '<rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line>',
        'check-square' => '<polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path>',
        'plug' => '<path d="M12 2v4"></path><path d="M12 18v4"></path><path d="M5 8h14"></path><path d="M6 11v4a6 6 0 1 0 12 0v-4"></path>',
        ...
        'coins' => '<circle cx="9" cy="9" r="7"></circle><path d="M15 9c0 3.87-3.13 7-7 7S1 12.87 1 9s3.13-7 7-7 7 3.13 7 7z"></path><circle cx="15" cy="15" r="7"></circle>',
        ...
        'tasks' => '<path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"></path><rect x="9" y="3" width="6" height="4" rx="2"></rect><path d="M9 14l2 2 4-4"></path>',
        ...
        'spinner' => '<circle cx="12" cy="12" r="10" stroke-opacity="0.25"></circle><path d="M12 2a10 10 0 0 1 10 10" stroke-opacity="1"></path>',
        ...
        'bell-slash' => '<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path><line x1="1" y1="1" x2="23" y2="23"></line>',
    ];

    return $icons[$name] ?? $icons['exclamation-circle'];
}
